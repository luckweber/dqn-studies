...
class DQNAgent:
    def __init__(self, env):
        ...
        self.image_width = 600                         # Input image width
        self.image_height = 150                        # Input image height
    ...
    def create_CNN_model(self):
        ...
        conv_1 = layers.Conv2D(32, (8,8), strides=4, padding='same', activation="relu")(frames_input)
        conv_2 = layers.Conv2D(64, (4,4), strides=2, padding='same', activation="relu")(conv_1)
        conv_3 = layers.Conv2D(64, (3,3), strides=1, padding='same', activation="relu")(conv_2)

        flatten_1 = layers.Flatten()(conv_3)
        
        dense_1 = layers.Dense(512, activation='relu', name='dense_1', kernel_initializer='glorot_uniform',bias_initializer='zeros')(flatten_1)
        output = layers.Dense(self.num_actions, activation='linear', name='output', kernel_initializer='glorot_uniform',bias_initializer='zeros')(dense_1)
        ...
        for time in range(time_steps):
            ...
            if frame_count % frame_skip == 0:
                ...
                if np.random.rand() <= agent.epsilon:
                    ...
                    #CNN
                    action = agent.greedy_action(current_state.reshape(1, current_state.shape[0], current_state.shape[1], current_state.shape[2]))
                    print("action ",action)
